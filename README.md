...
**2** parts · **1** processor underneath both · **4 KB** of memory shared with the console · **0** commands described by hand · both waits measured on the shipped microcode, **0** disagreements · **400** tests · **100%** statement and branch coverage · every image confirmed by **SHA-256** before a byte of it runs · no dependencies
